...
# THE FIX: Reduced the release gap to 0.04 so it doesn't get stuck holding
...
while True:
    ...
    if active_landmarks:
        ...
        if show_debug:
            # Draw the movement sensor clearly on the knuckle
        ...
        if not clutch_engaged:
            # THE FIX: Anchor movement to the knuckle, not the fingers
