...
# Updated to track "held" state instead of a single click
...
while True:
    ...
    if target_landmarks:
        ...
        # --- MOVEMENT ---
        # The cursor now moves smoothly even while a button is held down
        try:
...
# Safety catch: Ensure buttons are released if the script is closed
