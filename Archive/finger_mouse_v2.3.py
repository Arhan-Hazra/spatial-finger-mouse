...
# OPTIMIZATION 1: Lowered confidence thresholds to 50% to maintain tracking when fingers fold
...
while True:
    ...
    if target_landmarks:
        ...
        # We only extract the exact points we need for logic
        ...
        # OPTIMIZATION 2: "Just Dots" visual for zero-lag debug rendering
        if show_debug:
            # Draw tracking dots only on the critical joints
